...
// TestAllowCustomSecureBootKeys_EnableAlreadyCustom verifies the write happens even when the
...
// the doc comment on AllowCustomSecureBootKeys), so skipping based on it alone would silently
